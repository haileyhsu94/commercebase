                    ...
                    <TableRow key={feed.id}>
                      <TableCell className="py-4 pl-6">
                        <div className="space-y-0.5">
                          ...
                          <p className="text-[10px] uppercase tracking-wider text-muted-foreground">{feed.source}</p>
                        </div>
                      </TableCell>
                      <TableCell>
        ...
        <Card>
          ...
          <CardContent className="space-y-5">
            {catalogCategoryPerformance.map((category) => (
              <div key={category.name} className="group flex cursor-default items-center justify-between">
                <div className="space-y-0.5">
                  <p className="text-sm font-medium transition-colors group-hover:text-primary">{category.name}</p>
                  <p className="tabular-nums text-[10px] uppercase text-muted-foreground">{category.revenue}</p>
                </div>
                <div className="space-y-0.5 text-right">
                  ...
                  <div className="flex items-center justify-end gap-1">
                    ...
                    <span className="tabular-nums text-[11px] font-medium text-muted-foreground">{category.cvr} CVR</span>
                  </div>
                </div>
              </div>
            ))}
      ...
      <Card id="feed-issues">
        ...
        <div className="flex justify-center border-t p-6">
          <Button
            ...
            onClick={() => toast.info("Data quality rules coming soon")}
          >
